...
class RequestsDownloadAppEmptyScreenView extends View {
  constructor (options, context) {
    ...
    messageLayer.innerHTML = "To make BELDEX Requests,<br/><a href=\"https://mymonero.com\" target=\"_blank\" style='color: #11bbec; cursor: pointer; -webkit-user-select: none; text-decoration: none;'>download the app</a>."
