...
class RegisterTabContentView extends StackAndModalNavigationView {
  setup () {
    super.setup() // we must call on super
    const self = this
    { // walletsListView
      const options = {}
      const RegisterFundsView = require('./RegisterFundsView.Lite.web')
      const view = new RegisterFundsView(options, self.context)
      self.RegisterFundsView = view
    }
    self.SetStackViews(
      [
        self.RegisterFundsView
      ]
    )
  }
...
module.exports = RegisterTabContentView
