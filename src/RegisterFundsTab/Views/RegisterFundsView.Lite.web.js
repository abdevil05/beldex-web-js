...
class RegisterFundsView extends View {
  ...
  _setup_newTextInputField(placeholderText) {
    ...
    const labelLayer = commonComponents_forms.New_fieldTitle_labelLayer('REGISTRATION STRINGS', self.context);
    div.appendChild(labelLayer);
  ...
  pushDetailsViewFor_transaction (sentFrom_wallet, transaction) {
    ...
    }
    {
      ...
      const view = new JustRegisterTransactionDetailsView(options, self.context) // note JustRegisterTransactionDetailsView
